			...
			// Create book_tags table
				...
				//Create roles table
						$sql = "CREATE TABLE roles (
						 ...
						 if ($conn->query($sql) === TRUE) {
                                ...
                                $success=0;
                                echo '<br><div class="alert alert-danger" role="alert">
                                                Error creating table roles: ' . $conn->error .'
                                </div>';
                        }
				...
				//Create permissions table
						$sql = "CREATE TABLE permissions (
						 ...
						 if ($conn->query($sql) === TRUE) {
                                echo '<br><div class="alert alert-success" role="alert">
                                                Table permissions created successfully!
                                </div>';
                        } else {
                                $success=0;
                                echo '<br><div class="alert alert-danger" role="alert">
                                                Error creating permissions roles: ' . $conn->error .'
                                </div>';
                        }
				...
				//Create user_roles table
						$sql = "CREATE TABLE user_roles (
						 ...
						 if ($conn->query($sql) === TRUE) {
                                ...
                                $success=0;
                                echo '<br><div class="alert alert-danger" role="alert">
                                                Error creating table user_roles: ' . $conn->error .'
                                </div>';
                        }
