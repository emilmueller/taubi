        ...
        <div class="col-lg-8">
          ...
          <div class="row align-items-center">
            <div class="col-12">
                ...
                <button id="backButton" class="btn btn-secondary  float-end" onclick="window.location('/account/index.php', '_self')">Abbrechen</button>
                <button id="okButton" class="btn btn-secondary  float-end me-1" onclick="submit()">Buch speichern</button>
            </div>
          </div>
